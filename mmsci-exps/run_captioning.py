...
if __name__ == '__main__':
    ...
    argparser.add_argument('--input_filename', type=str, default='/mnt/raid0/zekun/MMSci/mmsci-data/benchmark/dev/image_caption_generation_data.json')
    argparser.add_argument('--base_output_dir', type=str, default='./eval/output/')
    argparser.add_argument('--image_dir', type=str, default='/mnt/raid0/zekun/MMSci/mmsci-data/benchmark/dev/images/')
